...
public class Prefab_ConnectWallet : MonoBehaviour
{
    ...
    public GameObject playWithoutWalletButton;
    ...
    async void OnConnected()
    {
        try
        {
            Debug.Log("Checking if owns NFTs....");
            // Connect to the smart contract
            // Replace this with your own contract address
            Contract contract = ThirdwebManager.Instance.SDK.GetContract("0x69BC6d095517951Df17f70f38746Bc27CE1C8A62");
            ...
            Debug.Log("Contract balance: " + balanceFloat);
        ...
        finally
        {
            ...
            playWithoutWalletButton.SetActive(false);
    ...
    void OnDisconnected()
    {
        ...
        playWithoutWalletButton.SetActive(true);
    }
